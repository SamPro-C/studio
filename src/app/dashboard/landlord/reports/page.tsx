...
const reportCategories: ReportCategory[] = [
  ...
  },
  {
    ...
    categoryIcon: Users,
    reports: [
      { title: "Vacancy Overview", description: "Track vacant units and overall occupancy rates.", icon: Home, actionText: "View Overview", onClickAction: () => alert("Vacancy Overview: To be implemented.") },
  ...
  },
  {
    ...
    categoryIcon: Wrench,
    reports: [
      { title: "Service Request Analysis", description: "Analyze service requests by type, status, and resolution time.", icon: ListChecks, actionText: "View Analysis", onClickAction: () => alert("Service Request Analysis: To be implemented.") },
