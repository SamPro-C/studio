    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-grow container py-12 md:py-20">
        <article className="prose prose-slate mx-auto dark:prose-invert lg:prose-xl max-w-3xl">
          ...
          <p>Welcome to Propero! These Terms of Service ("Terms") govern your use of the Propero application and services (collectively, the "Service") provided by Propero ("we," "us," or "our"). By accessing or using our Service, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use our Service.</p>
          ...
          <p>Propero provides distinct roles (Landlord, Tenant, Worker, Shop Manager, Admin). Your access to and use of features will depend on your assigned role. You agree not to misuse your access or attempt to access features not intended for your role.</p>
          ...
          <p>To the fullest extent permitted by law, in no event shall Propero be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from (a) your access to or use of or inability to access or use the Service; (b) any conduct or content of any third party on the Service.</p>
          ...
          <p>If you have any questions about these Terms, please contact us at <a href="mailto:support@propero.app" className="text-primary hover:underline">support@propero.app</a>.</p>
        </article>
      </main>
      <Footer />
    </div>
